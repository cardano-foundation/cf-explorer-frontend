          ...
          <Tabs style={{ flex: 1 }}>
            <Box width={"100%"}>
              ...
              >
                ...
                />
                <StyledTab value={"pools"} label={<StyledTabLabel active={+(tab === "pools")}>Pool Reports</StyledTabLabel>} />
              </StyledTabs>
            </Box>
          </Tabs>
        </TabHeader>
        <TabContent value={"stake-key"}>
          <StakekeySummary onSort={handleSort} fetchData={fetchDataStake} />
        </TabContent>
        <TabContent value={"pools"}>
          <PoolLifecycle onSort={handleSort} fetchData={fetchDataPool} />
        </TabContent>
      </TabContext>
    </Container>
  );
