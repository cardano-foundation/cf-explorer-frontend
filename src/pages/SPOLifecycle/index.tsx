            ...
            <BoxSwitchContainer sidebar={+sidebar}>
              ...
              <SwitchGroup>
                <ButtonSwitch active={+(validMode === "timeline")} onClick={() => changeMode("timeline")}>
                  <TableMode fill={validMode === "timeline" ? theme.palette.common.white : theme.palette.secondary.light} />
                </ButtonSwitch>
                <ButtonSwitch active={+(validMode === "tabular")} onClick={() => changeMode("tabular")}>
                  <ChartMode fill={validMode === "tabular" ? theme.palette.common.white : theme.palette.secondary.light} />
                </ButtonSwitch>
              </SwitchGroup>
            </BoxSwitchContainer>
            <CustomTooltip
