      ...
      <WrapContent>
        ...
        <BoxDetails>
          ...
          <NormalDescription>
            ...
            The delegator selects a staking pool to delegate their funds to. This is done through a wallet or a staking
            service. Cardano protocol, the following steps occur:
          </NormalDescription>
          <NormalDescription>
          ...
          <NormalDescription>
            ...
            The staking pool then generates a staking certificate for the delegator, which is essentially a proof of the
            delegation of funds. This certificate is stored on the Cardano blockchain and serves as a record of the
            delegation.
          </NormalDescription>
          <NormalDescription>
