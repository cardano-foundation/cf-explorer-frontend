  ...
  return (
    <StyledModal title='The deregistration process' handleCloseModal={handleCloseModal} open={open}>
      <WrapContent>
        ...
        <NormalDescription>
          It's important to note that a delegator should only initiate a deregistration request if they are sure they no
          longer want to participate in staking on Cardano. Once a delegation has been deregistered, it cannot be
          reversed, and the delegator will need to go through the process of re-delegating or withdrawing their funds if
          they wish to participate in staking again. In summary, when a delegator wants to deregister from staking on
          Cardano, they initiate a deregistration request which creates a deregistration certificate that is broadcast
          to the network. After a period of time, the delegation is considered to be fully withdrawn, and the
          delegator's funds are available for withdrawal or re-delegation.
        </NormalDescription>
      </WrapContent>
    </StyledModal>
  );
