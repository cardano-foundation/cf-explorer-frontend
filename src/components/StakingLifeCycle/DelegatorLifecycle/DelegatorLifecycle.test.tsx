...
describe("DelegatorLifecycle timeline view", () => {
  ...
  it("should render Registration", () => {
    render(<DelegatorLifecycle currentStep={0} setCurrentStep={jest.fn()} />);
  ...
  it("should render Delegation", () => {
    render(<DelegatorLifecycle currentStep={1} setCurrentStep={jest.fn()} />);
  ...
  it("should render Rewards Distribution", () => {
    render(<DelegatorLifecycle currentStep={2} setCurrentStep={jest.fn()} />);
  ...
  it("should render Rewards Withdrawal", () => {
    render(<DelegatorLifecycle currentStep={3} setCurrentStep={jest.fn()} />);
  ...
  it("should render Deregistration", () => {
    render(<DelegatorLifecycle currentStep={4} setCurrentStep={jest.fn()} />);
