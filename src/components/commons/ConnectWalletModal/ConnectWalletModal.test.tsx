...
describe("BookmarkButton component", () => {
  ...
  it("should all the wallets render", () => {
    render(<ConnectWalletModal connect={jest.fn()} openModal={true} onTriggerSignMessage={jest.fn()} />);
  ...
  it("should compoennt connect the wallet", async () => {
    ...
    render(<ConnectWalletModal connect={onConnect} openModal={true} onTriggerSignMessage={jest.fn()} />);
