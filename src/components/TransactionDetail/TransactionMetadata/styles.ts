...
export const CustomAccordion = styled(Accordion)<{ expanded: boolean; customBorderRadius: string }>(
  ({ expanded, customBorderRadius, theme }) => ({
    ...
    "&:before": {
      display: customBorderRadius !== "0" ? "none" : "block",
      width: "calc(100% - 40px)",
      margin: "0 auto",
      height: "2px",
