...
import {
  HashText,
  ItemTitle,
  PoolUpdateIconDeselectIcon,
  PoolUpdateIconSelectedIcon,
  PreviousIcon,
  PreviousText,
  RewardsDistributionDeselectIcon,
  RewardsDistributionSelectedIcon,
  TextTab,
  WrapperGrid,
  WrapperGridItem,
  WrapperItemUpdates
    ...
    <WrapperGrid>
      <WrapperGridItem>
        ...
        <Box marginTop={'8px'} gap={1} display={'flex'}>
          <HashText>{getShortHash(data.txnId)}</HashText>
