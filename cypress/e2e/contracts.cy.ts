...
describe("contracts spec", () => {
  it.skip("should show the contract details of transaction 4223b55d78e90917c5a6054c8a038124f7b1c0ecefc6751dd8bcd6a5016ae2d1", () => {
  ...
  it.skip("redirect to correct address detail page", () => {
    const address =
