...
describe("contracts spec", () => {
  it.only("should show the contract details of transaction 4223b55d78e90917c5a6054c8a038124f7b1c0ecefc6751dd8bcd6a5016ae2d1", () => {
    ...
    cy.wait(1000);
    cy.get('[data-testid="contract-tab"]');
  });
