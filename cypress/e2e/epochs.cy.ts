...
describe("epoch spec", () => {
  ...
  it("should have enough column", () => {
    ...
    cy.get(".css-1dz0v3k > tr > :nth-child(2)").contains("Start Timestamp", { matchCase: false });
    cy.get(".css-1dz0v3k > tr > :nth-child(3)").contains("End Timestamp", { matchCase: false });
    cy.get(".css-1dz0v3k > tr > :nth-child(4)").contains("Blocks");
    cy.get(".css-1dz0v3k > tr > :nth-child(5)").contains("Unique Accounts", { matchCase: false });
    cy.get(".css-1dz0v3k > tr > :nth-child(6)").contains("Transaction Count", { matchCase: false });
    cy.get(".css-1dz0v3k > tr > :nth-child(7)").contains("Rewards Distributed", { matchCase: false });
    cy.get(".css-1dz0v3k > tr > :nth-child(8)").contains("Total Output", { matchCase: false });
  });
