describe("User check Bookmark - Address in My Profile", () => {
    it("User go to Dashboard and sign in, then verify the Bookmark - Address in My Profile Screen", () => {
      ...
      cy.get('th').contains('Address').should('be.visible');
