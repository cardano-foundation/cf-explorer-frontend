describe("User check information of stake address deregistration", () => {
  it("User go to Stake Addess Deregistration and click to first record, then verify the Stake Addess Detail screen", () => {
    ...
    cy.get('[data-testid = "table-common"] tr th').should("be.visible").contains("Action");
    ...
    cy.get('[data-testid = "table-common"] tr th').should("be.visible").contains("Created At");
    cy.get('[data-testid = "table-common"] tr th').should("be.visible").contains("Block");
    cy.get('[data-testid = "table-common"] tr th').should("be.visible").contains("Amount");
    ...
    cy.get('[data-testid = "table-common"] tr th').should("be.visible").contains("Created At");
    cy.get('[data-testid = "table-common"] tr th').should("be.visible").contains("Block");
    cy.get('[data-testid = "table-common"] tr th').should("be.visible").contains("Fees");
    cy.get('[data-testid = "table-common"] tr th').should("be.visible").contains("ADA amount");
    cy.get('[data-testid = "table-common"] tr th').should("be.visible").contains("Token");
  });
});
