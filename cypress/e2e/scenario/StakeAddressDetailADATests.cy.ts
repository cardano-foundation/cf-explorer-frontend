...
describe("block spec", () => {
    it("should navigate to the blocks page", () => {
      ...
      cy.get('[data-testid="table-common"] th').eq(0).contains("Tx Hash");
      ...
      cy.get('[data-testid="table-common"] th').eq(0).contains("#");
      cy.get('[data-testid="table-common"] th').eq(1).contains("Tx Hash");
      cy.get('[data-testid="table-common"] th').eq(2).contains("Created At");
      cy.get('[data-testid="table-common"] th').eq(3).contains("Block");
      cy.get('[data-testid="table-common"] th').eq(4).contains("Fees");
      cy.get('[data-testid="table-common"] th').eq(5).contains("ADA amount");
      cy.get('[data-testid="table-common"] th').eq(6).contains("Token");
    });
  });