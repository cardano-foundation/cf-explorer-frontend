...
describe("contract scenario", () => {
  it("should navigate to the contract detail page", () => {
    ...
    cy.get("th").contains("Created At", { matchCase: false }).should("be.visible");
    cy.get("th").contains("Block", { matchCase: false }).should("be.visible");
    cy.get("th").contains("Addresses", { matchCase: false }).should("be.visible");
    cy.get("th").contains("Fees", { matchCase: false }).should("be.visible");
    cy.get("th").contains("Output", { matchCase: false }).should("be.visible");
